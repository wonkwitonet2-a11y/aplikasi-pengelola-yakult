...
// Now fix the avgSales to use pembagiTanggal instead of tgtObj.e6 if pembagiTanggal is available!
// "pembagi yang ada di realisasi" -> db.breakdownRealisasi?
const areaRealisasiTarget = `const ca25 = tgtObj.e6 || 12; // Hari Aktif sel CA25
  const avgSales = ca25 > 0 ? ylTotalActual / ca25 : 0;`;

const areaRealisasiNew = `  const areaStr = area.substring(0, 3);
